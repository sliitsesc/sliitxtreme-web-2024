...
export default function Hero() {
  return (
    <div className="bg-gradient-to-r from-[#11A3D6]  via-black to-[#884116] relative overflow-x-hidden">
      ...
      />
      <div className="w-full h-full bg-gradient-to-b from-[#00000000] via-[#00000000] via-[30%] to-[#000000] absolute"></div>
      <Navbar className={"z-[1] text-white"} />
      <section className="h-[calc(80svh)] min-h-[400px] md:h-[calc(100vh-68px)] md:min-h-[500px] px-2 text-white text-center flex flex-col justify-center z-[1]">
        <div className="container flex flex-col items-center mx-auto z-[1] text-center -mt-[105px]">
          <h1 className="text-[52px] leading-[52px] md:leading-normal md:text-[48px] font-bold dm-sans-600 mb-4 md:mb-2 drop-shadow-white-glow">
